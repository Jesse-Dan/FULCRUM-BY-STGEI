...
import '../../../../../components/ArrowBackHeader.dart';
import '../../../../../components/app_button.dart';
import '../../../../../components/app_notifier.dart';
...
import '../ExamStages/ExamReady.dart';

class Waec extends StatefulWidget {
  const Waec({super.key});

  @override
  State<Waec> createState() => _WaecState();
}
...
setQuestions(Subjects subjects, BuildContext context) {
  ...
  context.read<ExamBloc>().examVariables.currentQuestion =
      context.read<ExamBloc>().examVariables.selectedSubjects?[0].questions[0];
  Logger.log(
...
class _WaecState extends State<Waec> {
  @override
    ...
    return Container(
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ArrowBackHeader('Take an Exam - Waec Simulator', context),
            const SizedBox(height: AppDimentions.extraLarge),
            Text(
                'Welcome to STGEI HUB Past Question Examination Center, where you will study past questions for your upcoming exam. To start studying past question right now, please select the subjects to be examined on. English Language is compulsory, so you are allowed to select 3 other subjects of your choice belo. after selection click next to enter exam Mode.',
