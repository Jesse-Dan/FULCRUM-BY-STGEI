...
class _AppTextFieldState<T> extends State<AppTextField> {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: Column(
        ...
        children: [
          const SizedBox(height: AppDimentions.small),
          SizedBox(
            width: 288,
            child: Text(
              widget.labelText ?? '',
                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        border: OutlineInputBorder(
                            borderSide:
                                BorderSide(color: AppColors.kOtherPurple),
                      ...
                      cursorColor: AppColors.kOtherBlue,
                    ),
                  )
                : widget.textFieldType == TextFieldType.DROPDOWN
                    ? Container(
                        ...
                        decoration: BoxDecoration(
                            color: AppColors.kOtherPurple,
                            border: Border.all(color: AppColors.kOtherPurple),
                            borderRadius: BorderRadius.circular(4)),
                        child: Padding(
                    ...
                    : widget.textFieldType == TextFieldType.OTP
                        ? PinCodeTextField(
                            ...
                            pinTextStyle: TextStyle(
                              color: AppColors.kprimary600 .withOpacity(.7),
                              fontSize: 24,
                              fontFamily: 'Poppins',
                            ...
                            pinBoxColor: AppColors.kprimary600.withOpacity(0.09),
  ...
  BoxDecoration myPinBoxDecoration(
    ...
    return BoxDecoration(
      color: AppColors.kOtherBlue.withOpacity(0.2),
      borderRadius:
